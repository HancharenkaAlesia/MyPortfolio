...
var menu = function menu() {
  ...
  var menuOpen = function menuOpen(trigger) {
    trigger.addEventListener('click', function () {
      hamburgerMenu.classList.add('active');
    });
  };

  var menuClose = function menuClose(trigger) {
    trigger.addEventListener('click', function () {
...
/* harmony import */ var _modules_ratings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/ratings */ "./src/js/modules/ratings.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_ratings__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
